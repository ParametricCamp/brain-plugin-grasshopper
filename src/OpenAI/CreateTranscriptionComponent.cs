...
{
    public class CreateTranslationComponent : GH_Component_HTTPAsync_Form
    {
        const string ENDPOINT = "https://api.openai.com/v1/audio/translations";
        public string format = null;
        public CreateTranslationComponent() : base("Create Translation", "Translate", "Translates audio into into English.", "Brain", "OpenAI")
        {
        }

        public override Guid ComponentGuid => new Guid("{FF384093-60E8-4630-B57F-DB0025DD6FDD}");
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            string filePath = null, model = "whisper-1", prompt = null;
