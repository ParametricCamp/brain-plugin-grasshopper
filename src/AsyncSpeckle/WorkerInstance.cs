...
namespace Brain.GrasshopperAsyncComponent
{

    // https://github.com/specklesystems/GrasshopperAsyncComponent/blob/main/LICENSE

    /// <summary>
    /// A class that holds the actual compute logic and encapsulates the state it needs. Every <see cref="GH_AsyncComponentNumericalProgress"/> needs to have one.
    /// </summary>
    public abstract class WorkerInstance<T>
  {
    ...
    /// <summary>
    /// This token is set by the parent <see cref="GH_AsyncComponentNumericalProgress"/>. 
    /// </summary>
    public CancellationToken CancellationToken { get; set; }

    /// <summary>
    /// This is set by the parent <see cref="GH_AsyncComponentNumericalProgress"/>. You can set it yourself, but it's not really worth it.
    /// </summary>
    ...
    /// </summary>
    /// <returns></returns>
    public abstract WorkerInstance<T> Duplicate();
    ...
    public abstract void DoWork(Action<string, T> ReportProgress, Action Done, GH_Component Component);

    /// <summary>
    /// Write your data setting logic here. <b>Do not call this function directly from this class. It will be invoked by the parent <see cref="GH_AsyncComponentNumericalProgress"/> after you've called `Done` in the <see cref="DoWork(Action{string}, Action{string, GH_RuntimeMessageLevel}, Action)"/> function.</b>
    /// </summary>
    /// <param name="DA"></param>
    public abstract void SetData(IGH_DataAccess DA);

    /// <summary>
    /// Write your data collection logic here. <b>Do not call this method directly. It will be invoked by the parent <see cref="GH_AsyncComponentNumericalProgress"/>.</b>
    /// </summary>
    /// <param name="DA"></param>
