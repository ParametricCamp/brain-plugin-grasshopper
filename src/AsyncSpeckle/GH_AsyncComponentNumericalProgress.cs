...
namespace Brain.GrasshopperAsyncComponent
{
    ...
    /// </summary>
    public abstract class GH_AsyncComponentNumericalProgress : GH_Component
    {
        ...
        public List<WorkerInstance<double>> Workers;
        ...
        /// </summary>
        public WorkerInstance<double> BaseWorker { get; set; }
        ...
        protected GH_AsyncComponentNumericalProgress(string name, string nickname, string description, string category, string subCategory) : base(name, nickname, description, category, subCategory)
        {
            ...
            Workers = new List<WorkerInstance<double>>();
